...
struct ImGuiContext
{
    ...
    char                    TempBuffer[1024 * 2 + 1];           // Temporary text buffer
    ImVector<char>          TempBuffer2;                         // Temporary text buffer
...
//#endif
    ...
    IMGUI_API bool	    	HotkeyYai(const char* label, int& k, const ImVec2& size_arg);
    ...
    IMGUI_API void          BG0RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f);
    ...
    IMGUI_API bool          BG0ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
