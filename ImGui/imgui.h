...
namespace ImGui
{
    ...
    ImVec4                  HexToImVec4(const std::string& hexString, int alpha);
    ...
    IMGUI_API void          TextGradiented(const char* text, ImU32 leftcolor, ImU32 rightcolor, float smooth);
    ...
    IMGUI_API bool          BG0Button(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API void          CheckboxEx(const char* Text, bool* Point);
    IMGUI_API bool          CheckFullbox(const char* label, bool* v);
...
struct ImDrawList
{
    ...
    IMGUI_API void  DebugText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);
