...
#endif
#include <Windows.h>
#include "../Menu/utils/StringH.hpp"
...
void ImGui::TextGradiented(const char* text, ImU32 leftcolor, ImU32 rightcolor, float smooth) {
...
bool ImGui::BG0ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    {
        ImGuiWindow* window = GetCurrentWindow();
        if (window->SkipItems)
        ...
        // Render
        const ImU32 col = GetColorU32((held && hovered) ? ImGuiCol_ButtonActive : hovered ? ImGuiCol_Button : ImGuiCol_Button);
        RenderNavHighlight(bb, id);
        BG0RenderFrame(bb.Min, bb.Max, col, false, style.FrameRounding);
...
bool ImGui::BG0Button(const char* label, const ImVec2& size_arg)
{
    return BG0ButtonEx(label, size_arg, ImGuiButtonFlags_None);
}
...
//！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！徭協吶痕方
void ImGui::CheckboxEx(const char* Text, bool* Point)
{
    ...
    if (ImGui::IsItemHovered())
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(0.78f, 0.78f, 0.78f, 1.0f), ImVec4(0.86f, 0.07f, 0.23f, 11.0f), t));
    else
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(0.85f, 0.85f, 0.85f, 1.0f), ImVec4(0.78f, 0.07f, 0.15f, 11.0f), t));
...
//！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
bool ImGui::CheckFullbox(const char* label, bool* v)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::Hotkey(const char* label, int& key, float samelineOffset, const ImVec2& size) {
    ...
    bool clickVal = ButtonEx(key == 0 ? "..." : StringH::vkToString(key).c_str(), size, ImGuiButtonFlags_MouseButtonLeft | ImGuiButtonFlags_MouseButtonRight);
   if (IsItemHovered()) {
        ...
        else for (auto i = VK_MBUTTON; i <= VK_PACKET; i++) {
            //if (io.KeysDown[i]) {
...
//！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
bool ImGui::HotkeyYai(const char* label, int& k, const ImVec2& size_arg)
{
    ...
    const ImU32 col = ImGui::GetColorU32(ImGuiCol_Button);//函嘘尚弼
    ImGui::RenderFrame(frame_bb.Min, frame_bb.Max, col, true, style.FrameRounding);

    if (k != 0 && g.ActiveId != id) {
        strcpy_s(buf_display, KeyNames[k]);//協吶壓StringH.hpp
    }
...
void ImGui::NewLine()
{
    ...
    if (window->DC.CurrLineSize.y > 0.0f)     // In the event that we are on a line with items that is smaller that FontSize high, we will preserve its height.
        ...
        ItemSize(ImVec2(0.0f, g.FontSize/4));
